      ...
      <div className="mt-10 flex gap-10">
        <Tabs defaultValue="account" className="flex-1">
          <TabsList className='background-light800_dark400 min-h-[42px] p-1'>
            <TabsTrigger defaultValue="top-posts" className='tab'>Top Posts</TabsTrigger>
            <TabsTrigger defaultValue="comments" className='tab'>Comments</TabsTrigger>
          </TabsList>
        // TODO: Add apis for fetching posts and comments of the user
          <TabsContent defaultValue="top-posts">POSTS</TabsContent>
          <TabsContent defaultValue="comments">COMMENTS</TabsContent>
        </Tabs>
      </div>
    </>
  );
